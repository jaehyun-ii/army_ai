...
class Settings(BaseSettings):
    ...
    BACKUP_TIMEOUT: int = 600  # 10 minutes for backup operations
    RESTORE_TIMEOUT: int = 1200  # 20 minutes for restore operations
    MAINTENANCE_MODE: bool = False  # Set to True during restore
