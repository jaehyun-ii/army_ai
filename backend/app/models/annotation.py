...
class Annotation(Base):
    ...
    # Image references (exactly one of these must be set)
    image_2d_id = Column(UUID(as_uuid=True), ForeignKey("images_2d.id", ondelete="CASCADE"))
    image_3d_id = Column(UUID(as_uuid=True), ForeignKey("images_3d.id", ondelete="CASCADE"))
    ...
    image_3d = relationship("Image3D", back_populates="annotations")
