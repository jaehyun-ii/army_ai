...
export interface AdversarialPatch {
  ...
  target_class: string
  patch_size: number
  learning_rate?: number | null  // Optional, null means auto-configured
  iterations?: number
...
export interface GeneratePatchRequest {
  ...
  iterations?: number
  batch_size?: number
  learning_rate?: number | null  // Optional, null for auto-config
  description?: string
  created_by?: string
  session_id?: string
}
...
export type EvaluationPhase = 'pre_attack' | 'post_attack'
...
export interface EvaluationRun {
  ...
  metrics?: {
    // Multi-class metrics (전체 클래스 평가)
    map?: number
    map_50?: number
    map_75?: number
    // Single-class metrics (타겟 클래스 평가)
    ap?: number
    ap50?: number
    ap75?: number
    target_class?: string
  ...
  metrics_summary?: {
    ...
    // Robustness metrics (for attack evaluations)
    robustness?: {
      delta_map?: number
      delta_map50?: number
    ...
    [key: string]: number | string | undefined | Record<string, any>
  }
