    ...
    <Card className={combineStyles("w-full shadow-2xl", styles.card.base, className)}>
      <CardHeader className="text-center space-y-6 pb-8">
        ...
        <div className="space-y-3">
          <CardTitle className="text-primary">대한민국 육군</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-3">
            ...
            <Input
              id="username"
              type="text"
              placeholder="군번 또는 운용자 ID를 입력하세요"
        ...
        <div className="bg-surface-container/80 border border-border rounded-xl p-4 backdrop-blur-sm">
        ...
        <div className="text-center space-y-3 pt-4 border-t border-border">
          <div className="flex justify-center space-x-6 text-sm">
            <button className="text-primary hover:text-primary-foreground font-medium transition-colors duration-200 hover:underline">
              비밀번호 찾기
            </button>
          ...
          <p className="text-xs text-foreground">시스템 관리: 육군본부 정보통신단 © 2024</p>
        </div>
      </CardContent>
    </Card>
  )
