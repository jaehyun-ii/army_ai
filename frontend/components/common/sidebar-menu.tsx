            ...
            <button
              className={cn(
                ...
                isActive && !hasChildren
                  ...
                  : "text-muted hover:text-foreground hover:bg-gradient-to-r hover:from-slate-800/60 hover:to-slate-700/60"
              )}
              onClick={() => {
                if (hasChildren) {
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      activeSection === child.name
                        ? "text-foreground bg-gradient-to-r from-primary/15 to-accent/15 border-l-2 border-primary/50"
                        : "text-muted hover:text-foreground hover:bg-gradient-to-r hover:from-slate-800/40 hover:to-slate-700/40"
                    )}
