        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={visualization_data.overall_comparison}>
              ...
              <Legend />
              <Bar dataKey="clean" fill="var(--color-success)" name="Clean" />
              <Bar dataKey="adversarial" fill="var(--color-error)" name="Adversarial" />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={visualization_data.drops} layout="vertical">
              ...
              <Bar dataKey="drop_percentage" fill="var(--color-warning)" name="Drop %">
